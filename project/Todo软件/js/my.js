...
function reWrite() {
    ...
    $.each(data, function (index, val) {
        ...
        // <input type='checkbox'>
            ...
            if (val.isDone == 1) {
                str += "<li id='" + index + "'   style='background:#CCCCCC'><time>" + getYear(val.time) + "<br><span>" + gettime(val.time) + "</span></time> <p>" + val.con + "</p><span class='iconfont '>&#xe662;</span><div class='del'>删除</div></li>";
            }
        }
    })
    // <input type='checkbox'>
